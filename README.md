...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)   [![Kotlin](https://img.shields.io/badge/Kotlin-2.1.20-blue.svg)](https://kotlinlang.org) [![Compose](https://img.shields.io/badge/Compose-BOM-blue.svg)](https://developer.android.com/jetpack/compose/bom)


A lightweight Android library built on top of `BasicText` that provides text with configurable smooth fading effect on the last line, compatible with Compose BOM. You can control **width** of the fade area (through the `fadeWidth` parameter).

<img src="art/faded_text_preview.png" width="420">
